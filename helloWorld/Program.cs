...
namespace helloWorld
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine("I am {0} years old and yes it's {1} I am godlike", ageOne, isGodLike);
            //Console.WriteLine("I weigh around {0} ,and I am around {1} intches tall", weightOne,heightOne);

            //Console.WriteLine(ageTwo.Equals(45));
